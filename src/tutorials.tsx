...
const tutorials = {
	...
	"The first row of icons below each type show how many pokemon have same-type moves that are effective against that type.\n" +
	"Red icons indicate that a party member has a same type move that is supereffective against that type.\nBlue icons indicate that a party member's same type moves are all ineffective against that type.\n" +
